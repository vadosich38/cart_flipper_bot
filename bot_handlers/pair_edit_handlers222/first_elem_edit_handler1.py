...
async def get_first_elem(message: Message, state: FSMContext) -> None:
    ...
    data_formats_handler_to_edit(message=message, card_id=cur_card_id, elem_num=1)
...
@edit_pair_router.callback_query(F.data == "no_changes", StateFilter(BotStates.pair_editing_change_first_elem))
