...
def get_cards_paginator_ikb(checked=False) -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    if not checked:
        builder.row(InlineKeyboardButton(text=bot_texts['paginator_show_value'], callback_data='paginator_show_value'))
    else:
        nav_buttons = [
            builder.row(InlineKeyboardButton(text=bot_texts['paginator_learned'], callback_data='paginator_learned')),
            builder.row(InlineKeyboardButton(text=bot_texts['paginator_not_learned'],
                                             callback_data='paginator_not_learned')),
        ]
